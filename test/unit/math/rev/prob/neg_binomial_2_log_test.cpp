...
struct TestValue {
  ...
  TestValue(int _n, double _eta, double _phi, double _value, 
            double _grad_eta, double _grad_phi)
      : n(_n),
        eta(_eta),
        phi(_phi),
        value(_value),
